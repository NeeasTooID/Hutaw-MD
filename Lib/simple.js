...
`.trim()
    ...
    */
     ...
     * @param {Object} options
     */
    async sendButtonImg(jid, content, media, footer, button1, row1, options = {}) {
      const m = await this.prepareMessage(jid, media, MessageType.image)
      ...
      await this.sendMessage(jid, buttonMessage, MessageType.buttonsMessage, {
        ...options
      	...
      	if (e.toString().includes("marker was")) this.sendButtonImg(jid, content, media, footer, button1, row1, options)
     }
    }
